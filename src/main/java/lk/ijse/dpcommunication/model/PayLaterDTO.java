...
public class PayLaterDTO {
    ...
    public PayLaterDTO(String date, String order_id, String customer_name, String item_name, double qty, double unit_price, double total, String payment, double receivedMoney, double arrears, double updated_total) {
        this.date = date;
